...
const Terms = () => {
  const pageTitle = `Terms and Conditions - ${WEBSITE_NAME}`;
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">Last updated: July 17, 2024</p>
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li className="mb-2">
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EasyPomodoro.com.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Website</strong> refers to EasyPomodoro.com, accessible from <a href="https://easypomodoro.com/" rel="external nofollow noopener" target="_blank" className="text-blue-500">https://easypomodoro.com/</a>
        </li>
        <li className="mb-2">
      ...
      <h2 className="text-2xl font-bold mb-2">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      ...
      <h2 className="text-2xl font-bold mb-2">Disputes Resolution</h2>
      ...
      <h2 className="text-2xl font-bold mb-2">For European Union (EU) Users</h2>
      ...
      <h2 className="text-2xl font-bold mb-2">United States Legal Compliance</h2>
      <p className="mb-4">You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>

      <h2 className="text-2xl font-bold mb-2">Severability and Waiver</h2>
      ...
      <h3 className="text-xl font-bold mb-2">Waiver</h3>
      <p className="mb-4">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>

      <h2 className="text-2xl font-bold mb-2">Translation Interpretation</h2>
        ...
        <ul>
        <li>By email: hi@easypomodoro.com</li>
        </ul>
    </div>
  )
}
